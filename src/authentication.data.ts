import { z } from 'zod';
import { AccountSchema, type AccountData } from './account.data';

export const AuthenticationSchema = z.object({
  account_id: AccountSchema.optional().transform((account: AccountData | undefined): string | undefined => account?.id ),
